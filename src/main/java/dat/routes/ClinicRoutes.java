...
public class ClinicRoutes {
    ...
    public EndpointGroup getRoutes() {
        return () -> {
            ...
            post(clinicController::create, Role.ADMIN);
            ...
            post("{id}/opening-hours", clinicController::addOpeningHours, Role.ADMIN);
            ...
            post("{clinicId}/veterinarians/{vetId}", clinicController::addVeterinarianToClinic, Role.ADMIN, Role.VET);
            ...
            delete("{clinicId}/veterinarians/{vetId}", clinicController::removeVeterinarianFromClinic, Role.ADMIN, Role.VET);
        };
    }
}